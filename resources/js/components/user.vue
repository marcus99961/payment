                ...
                <div class="card-body">
                    <div class="shadow p-3 mb-5 bg-body rounded">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                            <tr v-for="(user, index) in users " :key="index" class="bg-transparent">
                                <td>{{index + 1}}</td>

                                <td>{{user.name}}</td>
                                <td @dblclick.prevent="attached(user)">{{user.email}}</td>
                                <td><img :src="'/'+ user.signature" class="image"/></td>
                                <td>{{user.department.name}}</td>

                                <td>
                                    {{user.role_id}}
                                    <!-- {{user.reg_no.length <=15 ? user.reg_no : user.reg_no.substr(0,15) + '...'}} -->
                                </td>

                                <td>
                                    <button @click="editUser(user)" class="btn btn-primary btn-sm mx-1">Edit</button>
                                    <!-- <button @click="removeUser(user)" class="btn btn-danger btn-sm mx-1">Delete</button>
                                    <button @click="renew(user)" class="btn btn-danger btn-sm mx-1">Renew</button> -->
